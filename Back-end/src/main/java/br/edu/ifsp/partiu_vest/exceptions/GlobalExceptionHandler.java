...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<RestError> handleEmailAlreadyUsed(EmailAlreadyUsedException ex,
                                                            HttpServletRequest request) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN)
                .body(RestError.of(HttpStatus.FORBIDDEN, ex.getMessage(), request.getRequestURI()));
    }
    @ExceptionHandler(InvalidCredentialsException.class)
    public ResponseEntity<RestError> handleInvalidCredentials(InvalidCredentialsException ex,
                                                              HttpServletRequest request) {
    ...
    public ResponseEntity<RestError> handleValidation(MethodArgumentNotValidException ex,
        ...
        return ResponseEntity.badRequest()
                .body(RestError.of(HttpStatus.BAD_REQUEST, mensagem, request.getRequestURI()));
    }
